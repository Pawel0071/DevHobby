...
public class DictionaryRegistryTests
{
    ...
    public void Load_ShouldLoadEntries_AndLogInformation()
    {
        ...
        {
            new ItemTagDefinition { Code = "weapon", DisplayName = "Weapon" },
            new ItemTagDefinition { Code = "armor", DisplayName = "Armor" }
        };
    ...
    {
        // Arrange
        var firstLoad = new List<ItemTagDefinition>
        {
            new ItemTagDefinition { Code = "weapon", DisplayName = "Weapon" }
        };
        var secondLoad = new List<ItemTagDefinition>
        {
            new ItemTagDefinition { Code = "armor", DisplayName = "Armor" }
        };
