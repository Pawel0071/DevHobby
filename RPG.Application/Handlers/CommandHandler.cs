...
public class CommandHandler : ICommandHandler<EquipItemCommand>,
    ...
    ICommandHandler<LoginCharacterCommand>,
    ICommandHandler<LogoutCharacterCommand>,
...

{
    ...
    public Task<CommandResult> HandleAsync(LoginCharacterCommand command, CancellationToken cancellationToken = default)
        => HandleSimple(command, command.CharacterId, "CommandHandler.Login",
            meta => new CharacterLoginRequestedEvent(meta, command.CharacterId), null, cancellationToken);

    public Task<CommandResult> HandleAsync(LogoutCharacterCommand command, CancellationToken cancellationToken = default)
        => HandleSimple(command, command.CharacterId, "CommandHandler.Logout",
            meta => new CharacterLogoutRequestedEvent(meta, command.CharacterId), null, cancellationToken);
